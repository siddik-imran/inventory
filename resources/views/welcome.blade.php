...
<body id="page-top">
    <div id="app">
        <div id="wrapper">
            <!-- Sidebar -->
        <nav id="sidebar" style="display: none" v-show=" $route.path === '/' || $route.path === '/register' ||
        $route.path === '/forget' ? false : true ">
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/store-employee" class="collapse-item" >Add New</router-link>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/store-supplier" class="collapse-item">Add New</router-link>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/store-category" class="collapse-item">Add New</router-link>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/store-product" class="collapse-item">Add New</router-link>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/store-expense" class="collapse-item">Add New</router-link>
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/latest-order" class="collapse-item">Latest Order</router-link>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    <!-- TopBar -->
                    <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar" style="display: none" v-show=" $route.path === '/' || $route.path === '/register' ||
                    $route.path === '/forget' ? false : true ">
                ...
                <footer class="sticky-footer bg-white" >
                    ...
                    <div class="copyright text-center my-auto">
                        ...
                        <b><a href="#" target="_blank">care&love</a></b>
                        </span>
                    </div>
                    </div>
                </footer>
