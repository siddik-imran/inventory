                                ...
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent="employeeInsert()" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <input type="date" class="form-control" id="exampleInputFirstName" placeholder="Joinning Date"   v-model="form.joining_date">
                                                    <small class="text-danger" v-if="errors.joining_date"> {{ errors.joining_date[0] }} </small>
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="exampleInputEmail" placeholder="Enter NID "   v-model="form.nid">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <input type="test" class="form-control" id="exampleInputFirstName" placeholder="Enter phone number"   v-model="form.phone">
